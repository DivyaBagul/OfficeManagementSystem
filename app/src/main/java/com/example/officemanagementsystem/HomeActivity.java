...
import com.example.officemanagementsystem.Model.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Firebase User
        FirebaseUser firebaseUser = efirebaseAuth.getCurrentUser();//it will access current user
        String uId = null;
            ...
            public void onClick(View v) {
                ...
                btn_save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String s_id = databaseReference.push().getKey();//s_id is a generic key which is going to push
